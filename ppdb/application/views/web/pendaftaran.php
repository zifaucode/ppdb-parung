            ...
            <div class="col-sm-12">
              ...
              <h2>
								<strong class="text-primary">
									<a href=""><img src="img/logo.png" alt="Logo" width="30" style="position:absolute;margin-top:-8px;"> <span style="margin-left:35px;color:#fff;">PPDB</span></a>
								</strong>
							</h>
              </div>
            </div>
      ...
      <div>
        ...
        <div class="page-content page-wizard">
          ...
          <div class="header" style="margin-top:-20px;">
            <h2>Pendaftaran PPDB VERIFIKASI JALUR PRESTASI</h2>
                      ...
                      <form role="form" class="wizard wizard-validation" data-style="sea" role="form" action="" enctype="multipart/form-data"  method="post">
                        ...
                        <fieldset>
                           ...
                           <div class="form-group" >
                              ...
                              <i class="fa fa-warning faa-flash animated c-yellow" style="font-size:97px"></i><br><br>
                              <span style="font-size:15px">
                                 Proses PPDBSMAN 1 PARUNG hampir selesai. Silakan periksa kembali data-data calon siswa yang sudah anda masukkan.
                                 <br><br>
                                 <div class="col-md-12" >
          ...
          <div class="footer">
            <div class="copyright">
              <p class="pull-left sm-pull-reset">
                <span>SMAN 1 PARUNG</a> <?php echo date('Y'); ?> </span>
              </p>
