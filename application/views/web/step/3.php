<div class="panel panel-primary">
  ...
  <div class="panel-body">
        ...
        <div class="form-group" style="padding-bottom:30px;">
            <label class="col-sm-3 control-label" style="text-align:right; margin-top:6px">Nama Lengkap Ayah <span class="text-danger">*</span></label>
...
<div class="panel panel-primary">
  ...
  <div class="panel-body">
        ...
        <div class="form-group" style="padding-bottom:30px;">
            <label class="col-sm-3 control-label" style="text-align:right; margin-top:6px">Nama Lengkap Ibu<span class="text-danger">*</span></label>
            <div class="col-sm-9 prepend-icon">
...
<div class="panel panel-primary">
  ...
  <div class="panel-body">
        ...
        <div class="form-group" style="padding-bottom:30px;">
            <label class="col-sm-3 control-label" style="text-align:right; margin-top:6px">Nama Lengkap Wali<span class="text-danger">*</span></label>
            <div class="col-sm-9 prepend-icon">
