  ...
  <div class="content">
    ...
    <?php if ($cek->status_pendaftaran == 'lulus') {?>
      <div class="panel panel-success">
        ...
        <div class="panel-body">
          <h3>
            <center>
              Selamat <b><?php echo $nama; ?></b> <span class="label label-success" style="font-size:20px;">Lulus</span> Seleksi Sebagai Calon Peserta Didik Baru Jalur Prestasi <b>SMAN 1 PARUNG</b>, Silahkan Cetak Surat Pengumuman Sebagai Bukti Lulus Seleksi.
              <hr>
        ...
        <div class="panel-body" style="color:red">
          <h3>
            <center>
              ...
              Sebagai Calon Peserta Didik Baru <b>SMAN 1 PARUNG</b>.
            </center>
            <br>
          </h3>
        </div>
    ...
    <?php }else{ ?>
      <div class="panel panel-info">
        ...
        <div class="panel-body">
          <h3>
            <center>~ Belum ada Pengumuman dari Panitia PPDB Online SMAN 1 PARUNG ~</center>
          </h3>
        </div>
      </div>
    <?php } ?>
