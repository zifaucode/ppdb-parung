					...
					<div class="sidebar-category sidebar-category-visible">
						...
						<div class="category-content no-padding">
							<ul class="navigation navigation-main navigation-accordion">
								...
								<li><a href="panel_siswa/cetak_keaslian" target="_blank"><i class="icon-printer2"></i> <span>Cetak Keaslian DOC</span></a></li>
								<li><a href="panel_siswa/cetak_deskripsi" target="_blank"><i class="icon-printer2"></i> <span>Cetak deskripsi Capaian</span></a></li>
								<li><a href="panel_siswa/cetak_borang" target="_blank"><i class="icon-printer2"></i> <span>Cetak borang isian data</span></a></li>
