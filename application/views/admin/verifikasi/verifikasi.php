          ...
          <tbody>
              ...
              foreach ($v_siswa->result() as $baris) {?>
                <tr>
                  ...
                  <td><a class="btn btn-primary" href="<?php echo $baris->linksert_prestasi; ?>" target="_blank"> <span>LIHAT SERTIFIKAT</span></a></td>
                   <td><a class="btn btn-primary" href="<?php echo $baris->linkvid_prestasi; ?>" target="_blank"> <span>LIHAT VIDIO</span></a></td>
